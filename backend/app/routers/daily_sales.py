...
@router.post("/api/admin/stores/{store_id}/daily-sales/close", response_model=DailySalesResponse)
async def close_daily_sales(store_id: UUID, svc: DailySalesService = Depends(get_daily_sales_service)):
